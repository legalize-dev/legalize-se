...
När en tjänsteman hos Finansinspektionen använder sig av terminalåtkomst, skall följande uppgifter dokumenteras i en journal, som inspektionen skall föra med hjälp av automatisk databehandling: 1. vem som har inhämtat uppgifter genom terminalåtkomsten, 2. tidpunkten då terminalåtkomsten har använts, och 3. det ärende till vilket de inhämtade uppgifterna hör. Finansinspektionen skall kontrollera journalen regelbundet. Journalen skall bevaras i minst två år.
