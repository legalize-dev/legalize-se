...
Upplysningstjänsten ska vara tillgänglig främst via internet, men även via telefon. Den information som tillhandahålls via internet ska i möjligaste mån vara utformad på ett enhetligt sätt och där så är lämpligt ges med hjälp av interaktiva lösningar. Förordning (2020:55).

##### 5 §

Det ska finnas ett råd som samordnar upplysningstjänsten. I rådet ska samtliga informationsansvariga myndigheter enligt 1 § andra stycket ingå. Konsumentverket ska samordna arbetet i rådet. Förordning (2025:515).
